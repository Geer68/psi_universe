...
export default function CardPsicologo({ psicologo }: { psicologo: Psicologo }) {
  return (
    <article className="flex items-center justify-center min-h-screen ">
      <Link href={`/psychologists/${psicologo.id}`}>
          ...
          <div className="pb-6">
            ...
            <div className=" mt-20 text-center">
              ...
              <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <div className=" font-semibold tracking-wide text-black dark:text-gray-300  text-xl">
                  Psi. {psicologo.apellido}
                </div>
              </div>
              <div className="w-full text-center">
                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                  <div className="flex space-x-2">
                    <a
                      className="p-1 -m-1 text-gray-400 hover:text-purple-800 focus:outline-none focus-visible:ring-2 ring-primary"
            ...
            <div className="pt-6 mx-6 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
              <div className="flex flex-wrap justify-center">
                <div className="w-full px-6">
                  <p className="mb-4 font-normal leading-relaxed text-gray-800">
                    {psicologo.descripcion.substring(0, 250)}
                  </p>
                </div>
              </div>
            </div>
